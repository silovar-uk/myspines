...
const [html, base, editorCss, responsive, density, refinementsCss, materiality, editor, model, modelRefinements, uiShell, uiStructure, refinements, events, version, bootstrap, manifest] = await Promise.all([
  read("../index.html"),
  read("../v4/base.css"),
  read("../v4/editor.css"),
...
assert.match(version, /myspines 0\.4\.3/u, "画面上のバージョンをpackageと一致させる");
...
console.log("myspines UI v4 material smoke checks passed");
