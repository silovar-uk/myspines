...
const [html, base, editorCss, responsive, density, refinementsCss, editor, model, modelRefinements, uiShell, uiStructure, refinements, events, bootstrap, manifest] = await Promise.all([
  read("../index.html"),
  read("../v4/base.css"),
  read("../v4/editor.css"),
