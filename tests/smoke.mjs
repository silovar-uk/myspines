...
const [html, base, editorCss, responsive, density, editor, model, uiShell, uiStructure, events, bootstrap, manifest] = await Promise.all([
  read("../index.html"),
  read("../v4/base.css"),
  read("../v4/editor.css"),
...
assert.match(density, /--outline-width:\s*248px/u, "アウトラインの初期占有幅を抑える");
assert.match(density, /--memo-width:\s*260px/u, "メモの初期占有幅を抑える");
...
console.log("myspines UI v4 compact smoke checks passed");
